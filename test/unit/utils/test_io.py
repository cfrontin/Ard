...
class TestReplaceKeyValueNotNoneOnly:
    def setup_method(self):
        ...
        self.output_dictionary = replace_key_value(input_dictionary, "a", 1, replace_none_only=False)
...
class TestReplaceKeyValueNoneOnly:
    def setup_method(self):
        ...
        self.output_dictionary = replace_key_value(input_dictionary, "a", 1, replace_none_only=True)
