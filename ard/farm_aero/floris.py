...
def create_FLORIS_turbine(
    ...
    pt_raw = np.genfromtxt(Path(data_path, filename_power_thrust), delimiter=",").T.tolist()
...
class FLORISFarmComponent:
    ...
    def setup(self):
        ...
        self.fmodel.set(
            ...
            turbine_type=[create_FLORIS_turbine(self.modeling_options["turbine"], data_path=data_path)],
        )
